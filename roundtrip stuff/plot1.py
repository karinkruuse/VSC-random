...
signals = [
    ("Photodetector 1", channels[2]["freq_dev"], (215/255, 27/255, 47/255),  1.5),
    ("Photodetector 2", channels[3]["freq_dev"], (41/255,  95/255, 36/255),  0.8),   # thinner – sits on top of red
...
out = "phasemeter_freq_asd_pub.svg"
