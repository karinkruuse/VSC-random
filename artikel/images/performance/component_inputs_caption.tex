...
\begin{figure*}[t]
    ...
    The predicted Newport carrier and first-order sideband readout noises
    ...
    $8\,\mathrm{mW}$ at the detector, with modulation depth $0.53\,\mathrm{rad}$.
    ...
    $2\,\mathrm{GS/s}$. The assumed white RIN is
    $0.9\times10^{-8}/\sqrt{\mathrm{Hz}}$, summed coherently between the beams.
    The model uses $35\,\mathrm{MHz}$ modulation and electrical carrier
    ...
    deconvolved into individual board noise sources. The comparison is not a
    measurement of the complete testbed sensitivity.}
